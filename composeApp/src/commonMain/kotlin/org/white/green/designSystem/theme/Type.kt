...
fun AppTypography() = Typography(
    ...
    titleLarge = TextStyle(fontSize = 22.sp, fontWeight = FontWeight.Bold, fontFamily = AppFontFamily()),
    titleMedium = TextStyle(fontSize = 16.sp, fontWeight = FontWeight.Bold, fontFamily = AppFontFamily()),
    titleSmall = TextStyle(fontSize = 14.sp, fontWeight = FontWeight.Bold, fontFamily = AppFontFamily()),
